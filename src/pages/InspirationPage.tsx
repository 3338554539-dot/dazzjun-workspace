...
import { AlertTriangle, ArrowDown, ArrowUp, Bold, Bookmark, BookOpenText, Edit3, ExternalLink, FolderCog, Globe2, Italic, List, ListOrdered, Pin, Plus, Quote, Search, Tags, Trash2 } from "lucide-react";
...
import { filterUnifiedInspirations, inspirationCoverCandidates, inspirationSourceLabel } from "../services/inspirationLibrary";
...
export function InspirationPage() {
  ...
  const submitExternal = async () => {
    ...
    add({ platform: result.platform, title: result.title, cover: result.cover, author: result.author, sourceText: form.sourceText.trim(), categoryId: form.categoryId, categoryName, aiTags: result.tags, content: result.title, image: result.cover, url: result.url });
